...
############################################################################################################################
from datasets.scannet200.scannet200_splits import HEAD_CATS_SCANNET_200, TAIL_CATS_SCANNET_200, COMMON_CATS_SCANNET_200
############################################################################################################################
# matrix: 4x4 np array
# points Nx3 np array
...
def get_instances(task, ids, class_ids, class_labels, id2label):
    instances = {}
    ...
    for id in instance_ids:
        ...
        COMMON_TAIL_LABELS = TAIL_CATS_SCANNET_200+COMMON_CATS_SCANNET_200
        #get their ids
        try:
            if task == "task1":
                if id2label[inst.label_id] in COMMON_TAIL_LABELS:
                    inst.label_id = 3000
        except:
            print(inst.label_id)
        #change them to 3000
        ...
        if inst.label_id in class_ids:
            ...
            # if id2label[inst.label_id]=='unknown':
            #     print(inst.vert_count)
